...
test: ## Installs composer dependencies
	U_ID=${UID} docker exec --user ${UID} ${DOCKER_BE} php vendor/bin/phpunit
...
code-style-test: ## Runs php-cs to fix code styling following Symfony rules
